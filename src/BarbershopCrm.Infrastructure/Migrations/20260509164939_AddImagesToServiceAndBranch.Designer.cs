...
namespace BarbershopCrm.Infrastructure.Migrations
{
    ...
    [Migration("20260509164939_AddImagesToServiceAndBranch")]
    partial class AddImagesToServiceAndBranch
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BarbershopCrm.Domain.Entities.UserToken", b =>
                {
                    ...
                    b.ToTable("UserTokens", null, t =>
                        {
                            t.HasCheckConstraint("CK_UserTokens_Purpose", "Purpose IN ('EmailVerification','PasswordReset')");
                        });
                });
